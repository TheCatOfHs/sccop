...
We have applied SCCOP to systematic search 82 compositions of B-C-N system, and newly discovered 28 stable low energy configurations, and you can download the data from [B-C-N_POSCAR](examples/BCN_stable_poscars.zip).
