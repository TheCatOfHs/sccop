...
class PostProcess(SSHTools, ListRWTools):
    ...
    def __init__(self, sleep_time=1):
        ...
        self.main_dielectric_path = f'~/ccop/{dielectric_path}'
        self.main_elastic_path = f'~/ccop/{elastic_path}'
        self.main_energy_path = f'~/ccop/{energy_path}'
        self.main_pbe_band_path = f'~/ccop/{pbe_band_path}'
        self.main_phonon_path = f'~/ccop/{phonon_path}'
            ...
            shell_script = f'''
                            ...
                            do
                                ...
                                if [ `cat CONTCAR|wc -l` -ne 0 ]; then
                                    ...
                                    cp vasp-3.vasp {self.main_energy_path}/out-$p
                                fi
                                cd ../
                                touch FINISH-$p
        ...
        for j, batch in enumerate(batches):
            shell_script = f'''
                            ...
                            do
                                ...
                                cp DPT.band.png {self.main_pbe_band_path}/band-$p.png
                                cd ../
                                touch FINISH-$p
                                mv FINISH-$p {self.main_ccop_out_dir}
                            done
        ...
        for j, batch in enumerate(batches):
            shell_script = f'''
                ...
                do
                    ...
                    cd /$p
                    cp {self.main_vasp_files_path}/Phonon/* .
                    cp {self.main_optim_strs_path}/$p POSCAR
